...
sed -i '/<tr><td width="33%"><%:CPU usage/a <tr><td width="33%"><%:Compiler author%></td><td><a target="_blank" href="https://www.yaohst.com">【菜芽博客】https://www.yaohst.com</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
sed -i '/<tr><td width="33%"><%:Compiler author/a <tr><td width="33%"><%:Firmware Update%></td><td><a target="_blank" href="https://pan.yaohst.com/OS/OpenWRT">点这里下载最新版本</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
export Op_name="OpenWrt-CAIYA"                     # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="OpenWrt_x64_全功能版 by CAIYA build $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
